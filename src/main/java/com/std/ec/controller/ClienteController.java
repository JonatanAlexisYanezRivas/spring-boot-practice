...
public class ClienteController {
    ...
    public ResponseEntity<?> showAll(@PathVariable Integer id){
        ...
        if(getList == null){
            return new ResponseEntity<>(MensajeResponse.builder()
                    .mensaje("No hay registros").object(null)
                    .build(), HttpStatus.OK );
        }
    ...
    public ResponseEntity<?> create(@RequestBody ClienteDto clienteDto){
        ...
        try {
            ...
            return new ResponseEntity<>(MensajeResponse.builder()
                    .mensaje(exDt.getMessage()).object(null)
    ...
    public ResponseEntity<?> update(@RequestBody ClienteDto clienteDto, @PathVariable Integer id){
        ...
        try {
            if(clienteService.existById(id)){
                ...
                return new ResponseEntity<>(MensajeResponse.builder()
                        .mensaje("El registro que intenta actualizar no se encuentra en creado").object(null)
    ...
    public ResponseEntity<?> ShowById(@PathVariable Integer id){
        ...
        if(cliente == null){
            return new ResponseEntity<>(MensajeResponse.builder()
                    .mensaje("El registro que intenta buscar no existe").object(null)
                    .build(), HttpStatus.NOT_FOUND );
        }
